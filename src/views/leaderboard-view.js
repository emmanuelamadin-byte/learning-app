...
export default function LeaderboardView({ profiles, sessions, onProfileOpen }) {
  ...
  const rows = buildLeaderboard(profiles, sessions, leaderboardMode).filter((row) =>
              ...
              ([value, label]) => html`
                <button
                  ...
                  className=${scope === value
                    ? "min-h-12 rounded-2xl border border-accent/30 bg-accent/12 px-4 text-sm font-semibold text-white"
                    : "min-h-12 rounded-2xl border border-white/8 bg-white/[0.03] px-4 text-sm font-semibold text-white/65"}
                >
                  ${label}
                </button>
              `,
              ...
              ([value, label]) => html`
                <button
                  ...
                  className=${metric === value
                    ? "min-h-12 rounded-2xl border border-accent2/30 bg-accent2/12 px-4 text-sm font-semibold text-white"
                    : "min-h-12 rounded-2xl border border-white/8 bg-white/[0.03] px-4 text-sm font-semibold text-white/65"}
                >
                  ${label}
                </button>
